...
class RegularUserAuthController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        return redirect()->route('regular_user.login')->with('success', 'Registration successful! Please login to continue.');
    }
    ...
    public function login(Request $request)
    {
        ...
        if (Auth::guard('regular_user')->attempt($credentials, $request->remember)) {
            ...
            return redirect()->intended(route('regular_user.dashboard'))->with('success', 'Login successful.');
        }
    ...
    public function logout(Request $request)
    {
        ...
        return redirect()->route('regular_user.login')->with('success', 'Logged out successfully.');
    }
